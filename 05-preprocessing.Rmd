...
![Sample Surface & Registration Window](static/image/WaveletConfirmation.png)

**Data Settings**: 

Start by using the <u> project and subject drop down menus </u> to select the subject whose MRI and CT images that will be imported. 
...
* **Nifti:** submit a single Nifti file representing the 3D brain scan (e.g. subject_MRI.nii)

> Note: Select the checkbox "Skip the FreeSurfer Reconstruction" if _______. By default, this will be checked because ______. 
...
> Note: Select the checkbox "Skip the CT Co-Registration" if ______. By default, this will be unchecked because __________. 
...
Begin in the data selection panel at left. 
