...
Begin in the Data Selection window to indicate the subject and corresponding project whose data will be checked. Once again, selecting `Sync from [Import LFP] module` will automatically select the project and subject that was just imported. 
